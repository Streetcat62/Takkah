...
class ProfileController extends UserBaseController
{
    ...
    {
        $user = $this->userRepository->userById(auth('sanctum')->user()->id);
        if ($user) {
    ...
    */
    ...
    public function passwordUpdate(PasswordUpdateRequest $request)
    {
        ...
        $result = $this->userService->updatePassword(auth('sanctum')->user()->uuid, $collection);
        if ($result['status']){
    ...
    public function passwordUpdateWithPhone(PasswordUpdateWithPhoneRequest $request)
    {
        $collection = $request->validated();
