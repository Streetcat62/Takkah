...
class CategoryRepository extends CoreRepository implements CategoryRepoInterface
{
    ...
    public function shopCategoryProduct($shopCategoryIds, $array, $perPage)
    {
    ...
    /**
     * @param Collection[]|Category $category
     * @return void
     */
    private function reportPaginateData($category, $key, &$paginate)
    {
