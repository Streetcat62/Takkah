...
class _$_LoginState extends _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(isLoading: $isLoading, showPassword: $showPassword, isKeepLogin: $isKeepLogin, isLoginError: $isLoginError, isEmailNotValid: $isEmailNotValid, isPasswordNotValid: $isPasswordNotValid, isGoogleLoading: $isGoogleLoading, email: $email, password: $password)';
  }
