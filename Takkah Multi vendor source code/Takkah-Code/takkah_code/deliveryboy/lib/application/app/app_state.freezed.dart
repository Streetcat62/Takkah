...
abstract class $AppStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({LanguageData? activeLanguage});
}
...
class _$_AppState extends _AppState {
  const _$_AppState({this.activeLanguage}) : super._();
...
abstract class _AppState extends AppState {
  const factory _AppState({final LanguageData? activeLanguage}) = _$_AppState;
