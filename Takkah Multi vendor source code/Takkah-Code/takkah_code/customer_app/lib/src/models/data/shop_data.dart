...
class ShopData {
  ShopData({
    ...
    String? updatedAt,
    dynamic deletedAt,
    List<ShopWorkingDay>? shopWorkingDay,
    List<ShopClosedDay>? shopClosedDay,
    ...
    _shopWorkingDay = shopWorkingDay;
    _shopClosedDay = shopClosedDay;
  ...
  ShopData.fromJson(dynamic json) {
    ...
    _phone = json['phone'];
    _showType = json['show_type'] ?? false;
    _open = json['open'] ?? false;
    _visibility = json['visibility'];
    _backgroundImg = json['background_img'];
    _logoImg = json['logo_img'];
    _minAmount = json['min_amount'] ?? 0;
    _status = json['status'];
    _statusNote = json['status_note'] ?? '';
    _ratingAvg = json['rating_avg'] ?? '0.0';
    ...
    if (json['shop_working_days'] != null) {
      ...
      json['shop_working_days'].forEach((v) {
        _shopWorkingDay?.add(ShopWorkingDay.fromJson(v));
      });
    }
    if (json['shop_closed_date'] != null) {
      _shopClosedDay = [];
      json['shop_closed_date'].forEach((v) {
        _shopClosedDay?.add(ShopClosedDay.fromJson(v));
      });
    }
  ...
  String? _updatedAt;
  dynamic _deletedAt;
  List<ShopWorkingDay>? _shopWorkingDay;
  List<ShopClosedDay>? _shopClosedDay;
  ...
  ShopData copyWith({
    ...
    List<ShopDelivery>? deliveries,
      ...
      ShopData(
        ...
        shopWorkingDay: shopWorkingDay ?? _shopWorkingDay,
        shopClosedDay: shopClosedDay ?? _shopClosedDay,
  ...
  List<ShopWorkingDay>? get shopWorkingDay => _shopWorkingDay;

  List<ShopClosedDay>? get shopClosedDay => _shopClosedDay;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (_shopWorkingDay != null) {
      map['shop_working_days'] = _shopWorkingDay?.map((v) => v.toJson()).toList();
    }
...
ShopClosedDay shopClosedDayFromJson(String str) => ShopClosedDay.fromJson(json.decode(str));
...
class ShopClosedDay {
  ...
  factory ShopClosedDay.fromJson(Map<String, dynamic> json) => ShopClosedDay(
    id: json["id"],
    day: json["day"],
  );
