...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(NetworkExceptions error, T? errorData) failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(NetworkExceptions error, T? errorData)? failure,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$FailureCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({NetworkExceptions error, T? errorData});
...
class _$Failure<T> implements Failure<T> {
  const _$Failure({required this.error, this.errorData});
  ...
  @override
  String toString() {
    return 'ApiResult<$T>.failure(error: $error, errorData: $errorData)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, error, const DeepCollectionEquality().hash(errorData));
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return failure?.call(error, errorData);
  }
