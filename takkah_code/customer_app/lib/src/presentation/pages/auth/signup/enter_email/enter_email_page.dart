...
import 'riverpod/provider/enter_email_provider.dart';
                  ...
                  child: Container(
                    ...
                    child: Consumer(
                      builder: (context, ref, child) {
                        final state = ref.watch(enterEmailProvider);
                        final event = ref.read(enterEmailProvider.notifier);
                        return Column(
                            ...
                            Row(
                              children: [
                                Checkbox(
                                  ...
                                  onChanged: (value) => event.toggleAgreed(),
                                ),
                                Text(
                              ...
                              children: <Widget>[
                                ...
                                ExtendedSignButton(
                                  ...
                                  onSignInWithFacebook: () {
                                    event.registerWithFacebook(context);
                                  },
                                  onSignInWithApple: () =>
                                      event.registerWithApple(context),
