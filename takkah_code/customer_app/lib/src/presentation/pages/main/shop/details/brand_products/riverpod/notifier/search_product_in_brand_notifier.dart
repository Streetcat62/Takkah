...
class SearchProductInBrandNotifier
    extends StateNotifier<SearchProductInBrandState> {
  final ProductsRepository _productsRepository;
  final CartsRepository _cartsRepository;
  Timer? _timer;

  SearchProductInBrandNotifier(this._productsRepository, this._cartsRepository)
      : super(const SearchProductInBrandState());
  ...
  Future<void> increaseProductCount({required ProductData product,}) async {
  ...
  Future<void> decreaseProductCount({required ProductData product}) async {
    int count =  LocalStorage.instance
        .getProductQuantity()
        .firstWhere(
            (element) =>
