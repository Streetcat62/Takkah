...
import 'package:sundaymart/src/models/data/local_cart.dart';
import '../../pages/main/shop/details/brand_products/riverpod/provider/search_product_in_brand_provider.dart';
import '../../pages/main/shop/details/riverpod/provider/shop_category_products_provider.dart';
...
class HorizontalProductItem extends ConsumerWidget {
    ...
    return Container(
        ...
        child: InkWell(
          onTap: () async {
            ...
            shopCategoriesNotifier.updateState();
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                //   ],
                // ),
                (LocalStorage.instance.getProductQuantity().firstWhere(
                    ...
                    : Text(
                        ...
                        style: AppStyle.interNoSemi(
                            size: 12.sp, color: isDarkMode ? AppColors.white : AppColors.lightBlack,),
                        maxLines: 1,
                        overflow: TextOverflow.ellipsis,
                      ),
                6.verticalSpace,
