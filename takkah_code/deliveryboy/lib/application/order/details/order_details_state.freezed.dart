...
abstract class $OrderDetailsStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, OrderDetailData? order});
}
...
class _$_OrderDetailsState extends _OrderDetailsState {
  const _$_OrderDetailsState({this.isLoading = false, this.order}) : super._();
  ...
  @override
  String toString() {
    return 'OrderDetailsState(isLoading: $isLoading, order: $order)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, order);
...
abstract class _OrderDetailsState extends OrderDetailsState {
  const factory _OrderDetailsState(
      {final bool isLoading,
      final OrderDetailData? order}) = _$_OrderDetailsState;
