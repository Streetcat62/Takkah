...
//        if (!Cache::get('bsdfqe.trda') || data_get(Cache::get('bsdfqe.trda'), 'active') != 1) {
//            abort(403);
//        }
...
//            }
     ...
     */
    public function paypalValidate(array $data): \Illuminate\Contracts\Validation\Validator|\Illuminate\Validation\Validator
    {
